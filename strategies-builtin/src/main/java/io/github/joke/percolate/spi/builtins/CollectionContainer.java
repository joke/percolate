 ...
 * (open the stream, close it, wrap a scalar) is identical. Supplying {@code collect} makes the kind a sequence.
 */
abstract class CollectionContainer extends Container {
