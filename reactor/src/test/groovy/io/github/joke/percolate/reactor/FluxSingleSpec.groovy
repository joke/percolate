...
/**
 * {@link FluxSingle} unit-tested mock-only over the {@link ResolveCtx} type-query seam: every seam question is
 ...
 */
@Tag('unit')
class FluxSingleSpec extends Specification {
