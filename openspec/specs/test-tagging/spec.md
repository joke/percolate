...
## Tests SHALL be tagged as unit or integration
...
## Gradle SHALL support tag-based test filtering
...
## Integration tests SHALL cover minimal functionality
