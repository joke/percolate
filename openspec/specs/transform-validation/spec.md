...
Defines the ValidateTransforms stage that verifies all resolved transforms have complete GraphPath chains from source to target type, producing error diagnostics for unresolvable type gaps with goal-directed messages.
