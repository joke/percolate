...
Defines the `ErrorMessages` utility for constructing rich, contextual error messages in the annotation processor, including fuzzy-match suggestions via Levenshtein distance.
