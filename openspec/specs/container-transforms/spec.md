# Container Transforms Spec

## Purpose

Defines the concrete TypeTransformStrategy implementations that handle direct assignability, sibling method calls, collection/stream conversions, and Optional wrapping/unwrapping/mapping.
