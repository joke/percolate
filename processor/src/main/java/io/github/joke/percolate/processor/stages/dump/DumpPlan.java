...
public final class DumpPlan implements Stage {
    ...
    void apply(final MapperGraph graph, final TypeElement mapperType) {
        ...
        final var fileName = fqn + ".plan.dot";
        final var dotOutput = dotRenderer.render(graph.planView(), mapperType);
        ...
        try {
            ...
            diagnostics.warning(mapperType, "Failed to write plan debug graph: " + e.getMessage());
        }
    }
}
