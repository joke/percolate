...
class DumpTransformGraphStageSpec extends Specification {
    ...
    def 'skips method when merged exploration graph is empty'() {
        ...
        final mapping = new ResolvedMapping([], 'src', null, 'name', null, null, [:], '', null)
    ...
    private ResolvedModel resolvedModelWithPath() {
        ...
        final mapping = new ResolvedMapping([], 'src', null, 'name', resolution, null, [:], '', null)
    ...
    private ResolvedModel resolvedModelWithSharedNodes() {
        ...
        final mapping1 = new ResolvedMapping([], 'src1', null, 'a', new TransformResolution(graph1, null), null, [:], '', null)
        final mapping2 = new ResolvedMapping([], 'src2', null, 'b', new TransformResolution(graph2, null), null, [:], '', null)
