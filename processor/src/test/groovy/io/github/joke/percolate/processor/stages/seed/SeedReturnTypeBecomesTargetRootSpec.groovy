...
@Tag('integration')
class SeedReturnTypeBecomesTargetRootSpec extends Specification {

    def 'return type becomes a target-root node in the seeded graph'() {
        given:
        def source = JavaFileObjects.forSourceString('test.ReturnTypeTargetRootMapper', '''
            import io.github.joke.percolate.Mapper;
            import io.github.joke.percolate.Map;

            @Mapper
            public interface ReturnTypeTargetRootMapper {
