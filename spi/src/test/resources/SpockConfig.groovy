...
// — intermittently failing the whole spec (e.g. ContainerSpec) rather than any single mutant, which pitest then
// misreports as widespread survived mutants unrelated to the actual code under test. Discovered independently for
// `spi` (change clean-up-test-coverage-tooling, task 6) before this file was found to already exist for `processor`.
runner {
